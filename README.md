        ...
        <div id="content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                <div class="email">
                                    <a href="#"><img src="images/mail_icon.png" /> Email : gratitudelandscaping@gmail.com</a>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                <div class="title">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                <div class="contact_nu">
                                    <a href="#"> <img src="images/phone_icon.png" /> Contact : +631-935-4928</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="slider_section banner_main">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="first-slide" src="images/header_background.jpeg" alt="First slide">
                            <div class="container">
                ...
                <strong class="dark_brown">Lawn & Hedgings</strong></h1>
                        ...
                        <div class="carousel-item">
                            <img class="third-slide" src="images/IMG-0330.JPG" alt="Third slide">
                            <div class="container">
                                <div class="carousel-caption relative">
                                    <br>
                                    <h1>Cleanup<br>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 pppp">
                            <div class="about_box">
                                <div class="about_box_text">
                                    ...
                                    <p>A local Long Island landscaping company working hard to provide our clients with consistency and reliability for their homes.  Serving towns across Suffolk County.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 pppp">
                            ...
                            <div class="about_box_img">
                                <figure><img src="images/IMG-1940.jpeg" alt="#" /></figure>
            ...
            <!-- Services -->
            <div id="services" class="services_icons">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                    ...
                    <div class="row">
                        <div class="icons">
                            <div class="icon">
                                <figure><img src="images/lawn_icon.png" alt="#" /></figure>
                                <h3>• Lawn Maintenance</h3>
                            </div>
                        </div>
                        <div class="icons">
                            <div class="icon">
                                <figure><img src="images/cleanup_icon.png" alt="#" /></figure>
                        ...
                        <div class="icons">
                            <div class="icon" >
                                <figure><img src="images/topsoil_icon.png" alt="#" /></figure>
                                <h3>• Topsoil/Mulch</h3>
                            </div>
                        </div>
                        <div class="icons">
                            <div class="icon">
                                <figure><img src="images/aeration.jpg" alt="#" /></figure>
                                <h3>• Aeration</h3>
                            </div>
                        </div>
                        <div class="icons">
                            <div class="icon">
                                <figure><img src="images/tree_trimming.png" alt="#" /></figure>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padddd">
                        <div class="map_section">
                            <div id="map">
                                <img src='images/Map_pic.png'> 
                                <!-- <script
                                    src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&callback=initMap&libraries=&v=weekly"
                                    async
    >                           </script> THIS WILL BE FILLED WHEN WE DECIDE TO PURCHASE THE GOOGLE API.  MAP DEEMED UNNECESSARY ATM -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer">
            <div class="copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <p>© All rights reserved to Gratitude Landscaping, LLC 2021</p>
